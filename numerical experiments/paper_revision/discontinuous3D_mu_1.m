...
load(strcat(['3d-discontinuous-reference-mu-' num2str(mu)]) )
...
save(strcat(['discontinuous3D-mu-' num2str(mu)]), 'errorGalerkin', 'timeGalerkin', 'iterGalerkin', ...
...
t = table(refinements, errorGalerkin, timeGalerkin, iterGalerkin, ...
    ...
    errorCGOpt, timeCGOpt, iterCGOpt, ...
    errorTS, timeTS)
writetable(t, strcat(['discontinuous-mu-' num2str(mu)]))
