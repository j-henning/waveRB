...
for refinementLevel_space = space_refinement
    for refinementLevel_time = refinementLevel_space
        ...
        problem = create1DWaveProblemDamped(problemConfiguration);
        fprintf(' Done!\n')
        ...
        for ii=[4] % Specify what to use for solving
            ...
            if l2error
                switch ii
                    ...
                    case 4
                        errorBackslash(refinementLevel_space, refinementLevel_time)  = sqrt(mean( (solBackslash-sol_ana).^2, 'all'))
                end
            end
...
plot(x,solBackslash(:,1), 'g:', 'LineWidth', 2)
...
plot(x,solBackslash(:,end), 'g:', 'LineWidth', 2)
...
for i=1:size(sol_ana,2)
    ...
    plot(x,solBackslash(:,i), 'g:', 'LineWidth', 2)
