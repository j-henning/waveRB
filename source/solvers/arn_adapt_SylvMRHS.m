...
% C1     - First factor of the right hand side
% C2     - Second factor of the right hand side
% m      - Maximum space dimension
% tol    - Stopping tolerance (backward error)
% s1     - Estimates for real spectral interval of A (associated with F(A))
% smax   - Estimates for real spectral interval of A (associated with F(A))
% s1B    - Estimates for real spectral interval of B (associated with F(B))
% smaxB  - Estimates for real spectral interval of B (associated with F(B))
