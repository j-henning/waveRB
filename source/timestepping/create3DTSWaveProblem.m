...
problemTS.M = kron(M1D, kron(M1D, M1D));
problemTS.A = kron(A, kron(M1D, M1D)) + kron(M1D, kron(A, M1D)) ...
    + kron(M1D, kron(M1D, A));
...
problemTS.Fvals = zeros((problemTS.ntest-sum(problemTS.offset_space))^3,problemTS.K);

if ~isempty(problemTS.f_time)
    if size(problemTS.f_space,2) == 3
        ...
        for i=1:length(problemTS.f_time)
            ...
            problemTS.ntest_space = length(problemTS.T_space) - problemTS.bSplineOrder;
            rhs_space_z = zeros(problemTS.ntest -(problemTS.offset_space(1)+problemTS.offset_space(2)),1);
            
            for j=1+problemTS.offset_space(1):problemTS.ntest_space-problemTS.offset_space(2)
                g = @(y) problemTS.f_space{i,3}(y) * Ndiff(problemTS.T_space, problemTS.bSplineOrder,0,j,(y==0)*(y+eps) + (y==1)*(y-eps) + (y > 0 && y < 1)*y);
                for step = 0:problemTS.bSplineOrder-1
                    rhs_space_z(j-problemTS.offset_space(1)) = rhs_space_z(j-problemTS.offset_space(1)) ...
                        + Gaussq(problemTS.T_space(j+step),problemTS.T_space(j+step+1),g,5);
                end
            end
            
            for k=1:problemTS.K
                problemTS.Fvals(:, k) = problemTS.Fvals(:,k) + kron(rhs_space_z, kron(rhs_space_y, rhs_space_x)).* problemTS.f_time{i}((k-1)/(problemTS.K-1));
            end
        end
        ...
        for i=1:length(problemTS.f_time)
            ...
            for j=1+problemTS.offset_space(1):problemTS.ntest-problemTS.offset_space(2)
                for k=1+problemTS.offset_space(1):problemTS.ntest-problemTS.offset_space(2)
                    for l=1+problemTS.offset_space(1):problemTS.ntest-problemTS.offset_space(2)
                        ...
                        for stepX = 0:problemTS.bSplineOrder-1
                            for stepY = 0:problemTS.bSplineOrder-1
                                for stepZ = 0:problemTS.bSplineOrder-1
                                    
                                    a = [problemTS.T_space(j+stepX), problemTS.T_space(k+stepY), problemTS.T_space(l+stepZ)];
                                    b = [problemTS.T_space(j+stepX+1), problemTS.T_space(k+stepY+1), problemTS.T_space(l+stepZ+1)];
                                    %                                   a = [problemTS.T_space(j), problemTS.T_space(k), problemTS.T_space(l)];
                                    %                                 b = [problemTS.T_space(j+problemTS.bSplineOrder), problemTS.T_space(k+problemTS.bSplineOrder), problemTS.T_space(l+problemTS.bSplineOrder)];
                                    %
                                    ...
                                    center = 0.5 * (a+b);
                                    if abs(problemTS.f_space{i}(center(1),center(2),center(3))) < eps && ...
                                            abs(problemTS.f_space{i}(a(1),a(2),a(3))) < eps && ...
                                            abs(problemTS.f_space{i}(a(1),a(2),b(3))) < eps && ...
                                            abs(problemTS.f_space{i}(a(1),b(2),a(3))) < eps && ...
                                            abs(problemTS.f_space{i}(a(1),b(2),b(3))) < eps && ...
                                            abs(problemTS.f_space{i}(b(1),b(2),b(3))) < eps && ...
                                            abs(problemTS.f_space{i}(b(1),b(2),a(3))) < eps && ...
                                            abs(problemTS.f_space{i}(b(1),a(2),b(3))) < eps && ...
                                            abs(problemTS.f_space{i}(b(1),a(2),a(3))) < eps
                                        continue;
                                    end
...
if ~isempty(problemTS.u_0) || ~isempty(problemTS.u_1)
    for j=1+problemTS.offset_space(1):problemTS.ntest-problemTS.offset_space(2)
        for k=1+problemTS.offset_space(1):problemTS.ntest-problemTS.offset_space(2)
            for l=1+problemTS.offset_space(1):problemTS.ntest-problemTS.offset_space(2)
                g = @(z)@(y)@(x) problemTS.u_0(x,y,z) .* ...
                    Ndiff(problemTS.T_space, problemTS.bSplineOrder,0,j,x) .* ...
                    Ndiff(problemTS.T_space, problemTS.bSplineOrder,0,k,y) .*...
                    Ndiff(problemTS.T_space, problemTS.bSplineOrder,0,l,z);
                h = @(z)@(y)@(x) problemTS.u_1(x,y,z) .* ...
                    Ndiff(problemTS.T_space, problemTS.bSplineOrder,0,j,x) .* ...
                    Ndiff(problemTS.T_space, problemTS.bSplineOrder,0,k,y) .* ...
                    Ndiff(problemTS.T_space, problemTS.bSplineOrder,0,l,z);
                    ...
                    for stepY = 0:problemTS.bSplineOrder-1
                        for stepZ = 0:problemTS.bSplineOrder-1
                            ...
                            if ~isempty(problemTS.u_0)
                                if abs(problemTS.u_0(center(1),center(2),center(3))) > eps || ...
                                        abs(problemTS.u_0(a(1),a(2),a(3))) > eps || ...
                                        abs(problemTS.u_0(a(1),a(2),b(3))) > eps || ...
                                        abs(problemTS.u_0(a(1),b(2),a(3))) > eps || ...
                                        abs(problemTS.u_0(a(1),b(2),b(3))) > eps || ...
                                        abs(problemTS.u_0(b(1),b(2),b(3))) > eps || ...
                                        abs(problemTS.u_0(b(1),b(2),a(3))) > eps || ...
                                        abs(problemTS.u_0(b(1),a(2),b(3))) > eps || ...
                                        abs(problemTS.u_0(b(1),a(2),a(3))) > eps
                                    U0(j-problemTS.offset_space(1), ...
                                        k-problemTS.offset_space(1), ...
                                        l-problemTS.offset_space(1)) = ...
                                        U0(j-problemTS.offset_space(1), ...
                                        k-problemTS.offset_space(1), ...
                                        l-problemTS.offset_space(1)) + Gaussq(a,b,g,5);
                                end
                            end
                            
                            if ~isempty(problemTS.u_1)
                                if abs(problemTS.u_1(center(1),center(2),center(3))) > eps || ...
                                        abs(problemTS.u_1(a(1),a(2),a(3))) > eps || ...
                                        abs(problemTS.u_1(a(1),a(2),b(3))) > eps || ...
                                        abs(problemTS.u_1(a(1),b(2),a(3))) > eps || ...
                                        abs(problemTS.u_1(a(1),b(2),b(3))) > eps || ...
                                        abs(problemTS.u_1(b(1),b(2),b(3))) > eps || ...
                                        abs(problemTS.u_1(b(1),b(2),a(3))) > eps || ...
                                        abs(problemTS.u_1(b(1),a(2),b(3))) > eps || ...
                                        abs(problemTS.u_1(b(1),a(2),a(3))) > eps
                                    U1(j-problemTS.offset_space(1), ...
                                        k-problemTS.offset_space(1), ...
                                        l-problemTS.offset_space(1)) = ...
                                        U1(j-problemTS.offset_space(1), ...
                                        k-problemTS.offset_space(1), ...
                                        l-problemTS.offset_space(1)) + Gaussq(a,b,h,5);
                                end
                            end
                        end
                    end
