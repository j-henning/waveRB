...
parfor k = 1:length(ran15)
    ...
    B = kron(T11,M21) + kron(M12,S22) + a(k) * kron(M12,M21);
...
%save('Data_Normal/refInt15_RefLev7_Gauss15','e');
%save('Data_Normal/refInt15_RefLev7_Gauss15_L1','L1');
%save('Data_Normal/refInt15_RefLev7_Gauss15_L2','L2');
%save('Data_Normal/refInt15_RefLev7_Gauss15_L3','L3');
%save('Data_Normal/refInt15_RefLev7_Gauss15_L20','L20');
